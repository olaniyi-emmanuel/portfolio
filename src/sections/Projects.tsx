    ...
    <section className="pb-16 lg:py-24 ">
      <div className="container">
        <div className="flex justify-center">
          <p
            className="uppercase tracking-widest font-semibold bg-gradient-to-r
           from-emerald-300 to-sky-400 text-center text-transparent bg-clip-text "
          >
            Real World Results
          </p>
        </div>
        <h2 className="font-serif text-center text-5xl mt-6 md:text-5xl ">
          Featured Projects
        </h2>
        <p
          className="text-center md:text-lg max-w-md
         mx-auto font-sans text-white/60 mt-4 lg:text-xl"
        >
          See how I transformed concepts into engaging digital experiences.
        </p>
        <div className="flex flex-col mt-10 gap-20 md:mt-4">
          {portfolioProjects.map((project) => (
            ...
            >
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16 ">
                ...
                uppercase font-bold tracking-widest text-sm text-transparent bg-clip-text"
                  >
                  ...
                  <a href={project.link}>
                    <button
                      className="text-gray-950 bg-white h-12 w-full rounded-xl
